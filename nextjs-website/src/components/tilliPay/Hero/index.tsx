...
export default function Hero() {
	return (
		<div className='relative z-10'>
			...
			<EllipseSVG className='border-2 border-red-500 absolute bottom-0 size-full left-0 xl:h-2/3 z-0 pointer-events-none' />

			{/* Foreground content */}
			<div className='relative z-10 flex flex-col items-center justify-center gap-4 @xl:max-w-2xl text-center mx-auto'>
				<HeroLeft />
				<MacbookDisplayingInvoicesPage className='w-100 xl:w-250 mt-25' />
			</div>
