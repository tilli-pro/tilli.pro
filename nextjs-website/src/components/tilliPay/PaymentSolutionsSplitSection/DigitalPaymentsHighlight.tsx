...
export default function DigitalPaymentsHighlight() {
	return (
		<div className='pt-10 h-140 relative border [background-image:var(--gradient-card-bg)] border-b-figma-gray-light rounded-lg p-6 2xl:w-2/5 space-y-6 overflow-hidden'>
