...
function GradientChevronLeftSVG({
	className,
	...props
	...
	return (
		...
		>
			<path
				d='M18.75 23.275l-7.5-7.5 7.5-7.5'
				stroke='url(#paint0_linear_765_38726)'
				strokeWidth={1.5}
				strokeLinecap='round'
...
export default GradientChevronLeftSVG;
